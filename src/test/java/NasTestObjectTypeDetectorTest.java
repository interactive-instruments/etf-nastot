...
public class NasTestObjectTypeDetectorTest {
	...
	public void test24_Bestandsdatenauszug_6() throws URISyntaxException, IOException, TestObjectTypeNotDetected,
		...
		final DetectedTestObjectType detectedType = TestObjectTypeDetectorManager.detect(
				Resource.create("test",
						new URI("https://www.geobasis-bb.de/dienstleister/testdaten/AFIS_NAS_Beispieldaten_Bestand_BB.xml")));
		assertNotNull(detectedType);
		assertEquals("afdd346a-1658-4345-8e16-8007549c0b1d", detectedType.getId().toString());
	...
	public void test24_NutzerbezogeneBestandsdatenaktualisierung_NBA_6() throws URISyntaxException, IOException, TestObjectTypeNotDetected,
		...
		final DetectedTestObjectType detectedType = TestObjectTypeDetectorManager.detect(
				Resource.create("test",
						new URI("https://www.geobasis-bb.de/dienstleister/testdaten/AFIS_NBA_Beispieldaten_Folgeabgabe_BB.xml")));
		assertNotNull(detectedType);
		assertEquals("24ac3226-c322-4d84-b9ac-65444f8fc129", detectedType.getId().toString());
		assertEquals("ad33a664-e10a-4d09-87fa-f16e49042be8", detectedType.getParent().getId().toString());
	}
